...
# styled_label = tk.Label(root, text="Syled text", fg="blue", bg="yellow", font=("Arial", 14))
...
tk.Button(frame, text="Ahoj", command=lambda: print("Ahoj")).grid(row=5, column=2)
frame.pack()
tk.Button(root, text="Ahoj", command=lambda: print("Ahoj")).pack()

from tkinter import messagebox

tk.Button(root, text="Messagebox", command=lambda: messagebox.showwarning("Title", "Text")).place(x=50, y=100)

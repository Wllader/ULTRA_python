...
tk.Button(root, text="Checkbox value", command=lambda: print(varA.get())).pack()
...
tk.Button(root, text="Radio buttons 1&2", command=lambda: print(varB.get())).pack()
tk.Button(root, text="Radio button 3", command=lambda: print(varC.get())).pack()

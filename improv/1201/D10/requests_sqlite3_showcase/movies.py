...
with sqlite3.connect("files/Movies.db") as conn:
    ...
    # for d in directors:
    #     cursor.execute("INSERT INTO t_Director (vch_FirstName, vch_LastName, d_Birth) VALUES (?, ?, ?)", d)

    # for m in movies:
    #     cursor.execute("INSERT INTO t_Movie (vch_Title, d_Premiere, fk_DirectorId) VALUES (?, ?, ?)", m)

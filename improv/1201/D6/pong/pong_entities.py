...
class PongBot(PongEntity):
    ...
    def update(self, dt): #todo Rewrite logic using unimplemented methods
        if self.ball:
    ...
    def drift_towards(self, center:tuple): #todo Implement drifting towards given coordinates (with our speed)
        pass

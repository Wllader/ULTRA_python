...
class Tween:
    ...
    def EaseOutSine(total_time_ms:int=1000, clipped:tuple=None) -> "Tween":
        return Tween(total_time_ms, lambda t: sin((t * pi) / 2), clipped)
    

    @staticmethod
    def EaseInOutExpo(total_time_ms:int=1000, clipped:tuple=None) -> "Tween":
        ...
        return Tween(total_time_ms, easeInOutExpo, clipped)

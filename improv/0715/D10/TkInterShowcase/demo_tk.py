...
class ExampleApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        tk.Checkbutton(self, text="Subscribe to our newsletter", variable=self.subscribe_var).pack(pady=5)
    ...
    def on_click(self):
        ...
        if country.lower() == "select":
            messagebox.showwarning("Input needed", "Pick one of the countires!")
            return

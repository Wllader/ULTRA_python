...
class Square(Entity):
    def __init__(self, screen, init_center_pos):
        ...
        self.color_tween = Tween.EaseOutBounce(800, clipped=(0, 255))
        self.pos_tween = Tween.EaseOutBounce(1200)
    ...
    def change_pos(self, p:tuple[int]):
        self._center_pos = self.center_pos
        self._new_center_pos = np.array(p)

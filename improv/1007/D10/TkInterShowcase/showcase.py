...
tk.Button(frame, text="Ahoj", command=lambda:print("Ahoj!")).grid(row=3, column=3)
...
tk.Button(root, text="Messagebox", command=lambda:messagebox.showerror("Title", "Text")).pack()

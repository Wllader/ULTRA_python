...
# df_sorted["Glucose_Rollong"] = df_sorted["Glucose"].rolling(window=60).mean()
# df_sorted[["BloodPressure", "Glucose", "Glucose_Rollong"]].plot(x="BloodPressure", title="Rolling average")
# plt.show()

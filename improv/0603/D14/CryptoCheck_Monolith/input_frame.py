...
class InputFrame(ctk.CTkFrame):
    def __init__(self, master, fetch:Callable = None, **kwargs):
        ...
        ctk.CTkRadioButton(self, text="Coin", variable=self.type, value=TickerType.COIN).grid(row=2, column=0)
        ctk.CTkRadioButton(self, text="Share", variable=self.type, value=TickerType.SHARE).grid(row=2, column=1)

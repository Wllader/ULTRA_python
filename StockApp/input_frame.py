...
class InputFrame(ctk.CTkFrame):
    def __init__(self, master, fetch:Callable, **kwargs):
        ...
        self.symbol_label = ctk.CTkLabel(self, text="Enter Stock/Crypto Symbol:")
        ...
        self.days_label = ctk.CTkLabel(self, text="Enter Number of Days:")
    ...
    def set_fetch_command(self, command:Callable):
        self.fetch = command


if __name__ == "__main__":
    app = ctk.CTk()
    InputFrame(app, lambda: print("Hledám data...")).pack()
